...
namespace meta
{
    ...
    constexpr bool distance_smaller_than(Iter begin, Iter end) noexcept
    {
    ...
    constexpr bool distance_smaller_than(std::ptrdiff_t required_dist, Iter begin, Iter end) noexcept
    {
        std::ptrdiff_t offset = 0;
