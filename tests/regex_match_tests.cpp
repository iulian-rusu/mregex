...
namespace cx::tests
{
    ...
    static_assert(regex<R"([0-Z]+)">::with_flags<flag::ignore_case>::match("1234abczABCZ"sv));
    ...
    static_assert(regex<R"((a|ab|abc)+x)">::with_flags<flag::greedy_alt>::match("abx"sv));
    static_assert(regex<R"((a|ab|abc)+x)">::with_flags<flag::greedy_alt>::match("abcx"sv));
    static_assert(regex<R"((a|ab|abc)+x)">::with_flags<flag::greedy_alt>::match("aabcaaabababcx"sv));
    ...
    static_assert(regex<R"(.+)">::with_flags<flag::dotall>::match("\neven new lines!"sv));
    ...
    static_assert(regex<R"(0x(\h+)h?)">::with_flags<flag::ignore_case>::match("0X012323EJH"sv) == false);
