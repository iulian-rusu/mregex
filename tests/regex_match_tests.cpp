...
namespace meta::tests
{
    ...
    static_assert(regex<R"(a|ab|abc)">::with<flag::a>::match("ab"sv));
    static_assert(regex<R"(a|ab|abc)">::with<flag::greedy_alt>::match("abc"sv));
    static_assert(regex<R"(abc|ab|a)">::with<flag::greedy_alt>::match("abc"sv));
    static_assert(regex<R"(abc|ab|a)">::with<flag::greedy_alt>::match("ab"sv));
    static_assert(regex<R"(abc|ab|a)">::with<flag::greedy_alt>::match("a"sv));
    static_assert(regex<R"((a|ab)+x)">::with<flag::greedy_alt>::match("aaaababx"sv));
    static_assert(regex<R"((a|ab|abc)+x)">::with<flag::greedy_alt>::match("ax"sv));
    ...
    static_assert(regex<R"((?>ab|b)+c)">::match("abbc"sv) == false);
    ...
    static_assert(regex<R"(a|ab|abc)">::with<flag::a>::match("a|ab|abc"sv) == false);
    static_assert(regex<R"(a|ab|abc)">::with<flag::greedy_alt>::match("aba"sv) == false);
    static_assert(regex<R"((a|ab)+x)">::with<flag::greedy_alt>::match("aaaabcabx"sv) == false);
    static_assert(regex<R"((a|ab|abc)+x)">::with<flag::greedy_alt>::match("x"sv) == false);
}
