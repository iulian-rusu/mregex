...
namespace meta::tests
{
    ...
    using infinity = symbol::quantifier_inf;

    static_assert(symbol::is_quantifier<zero>);
    static_assert(symbol::is_quantifier<infinity>);
    ...
    static_assert(symbol::is_zero<infinity> == false);

    static_assert(symbol::is_infinity<infinity>);
