...
namespace meta::tests
{
    ...
    namespace
    {
        ...
        inline constexpr bool matching_inversion = std::is_same_v<invert_t<AST>, Expected>;
    }

    static_assert(matching_inversion<nothing, nothing>);
    static_assert(matching_inversion<literal<'a'>, literal<'a'>>);
    static_assert(
        matching_inversion
        <
            plus<literal<'a'>>,
